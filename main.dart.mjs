...
_1599: (x0,x1) => ({next: x0,error: x1}),
_1600: x0 => ({vapidKey: x0}),
_1601: x0 => globalThis.firebase_messaging.getMessaging(x0),
_1603: (x0,x1) => globalThis.firebase_messaging.getToken(x0,x1),
_1604: () => globalThis.firebase_messaging.isSupported(),
_1605: (x0,x1) => globalThis.firebase_messaging.onMessage(x0,x1),
_1609: x0 => x0.title,
_1610: x0 => x0.body,
_1611: x0 => x0.image,
_1612: x0 => x0.messageId,
_1613: x0 => x0.collapseKey,
_1614: x0 => x0.fcmOptions,
_1615: x0 => x0.notification,
_1616: x0 => x0.data,
_1617: x0 => x0.from,
_1618: x0 => x0.analyticsLabel,
_1619: x0 => x0.link,
_1620: f => finalizeWrapper(f,x0 => dartInstance.exports._1620(f,x0)),
_1621: f => finalizeWrapper(f,x0 => dartInstance.exports._1621(f,x0)),
_1623: () => globalThis.Notification.requestPermission(),
_1625: () => globalThis.firebase_core.SDK_VERSION,
_1632: x0 => x0.apiKey,
_1634: x0 => x0.authDomain,
_1636: x0 => x0.databaseURL,
_1638: x0 => x0.projectId,
_1640: x0 => x0.storageBucket,
_1642: x0 => x0.messagingSenderId,
_1644: x0 => x0.measurementId,
_1646: x0 => x0.appId,
_1648: x0 => x0.name,
_1649: x0 => x0.options,
_1650: (x0,x1) => x0.createElement(x1),
_1651: (x0,x1) => x0.debug(x1),
_1652: f => finalizeWrapper(f,x0 => dartInstance.exports._1652(f,x0)),
_1653: f => finalizeWrapper(f,(x0,x1) => dartInstance.exports._1653(f,x0,x1)),
_1654: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
_1655: (x0,x1,x2) => x0.createPolicy(x1,x2),
_1656: (x0,x1) => x0.createScriptURL(x1),
_1657: (x0,x1,x2) => x0.createScript(x1,x2),
_1658: (x0,x1) => x0.appendChild(x1),
_1659: (x0,x1) => x0.appendChild(x1),
_1660: f => finalizeWrapper(f,x0 => dartInstance.exports._1660(f,x0)),
_1661: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
_1670: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
_1695: (x0,x1) => x0.getItem(x1),
_1697: (x0,x1,x2) => x0.setItem(x1,x2),
_1698: (x0,x1,x2) => x0.setAttribute(x1,x2),
_1699: (x0,x1) => x0.querySelector(x1),
_1700: (x0,x1) => x0.append(x1),
_1701: (x0,x1) => x0.querySelector(x1),
_1702: (x0,x1) => x0.querySelector(x1),
_1703: x0 => x0.remove(),
_1704: (x0,x1) => x0.append(x1),
_1705: (x0,x1) => x0.querySelector(x1),
_1706: (x0,x1) => x0.getAttribute(x1),
_1707: (x0,x1,x2) => x0.setAttribute(x1,x2),
_1708: (x0,x1) => x0.matchMedia(x1),
...
_1753: (decoder, codeUnits) => decoder.decode(codeUnits),
_1754: () => new TextDecoder("utf-8", {fatal: true}),
_1755: () => new TextDecoder("utf-8", {fatal: false}),
_1756: v => stringToDartString(v.toString()),
_1757: (d, digits) => stringToDartString(d.toFixed(digits)),
_1761: o => new WeakRef(o),
_1762: r => r.deref(),
_1767: Date.now,
...
_1780: s => stringToDartString(JSON.stringify(stringFromDartString(s))),
_1781: s => printToConsole(stringFromDartString(s)),
_1790: (o, t) => o instanceof t,
_1792: f => finalizeWrapper(f,x0 => dartInstance.exports._1792(f,x0)),
...
_1800: () => Date.now(),
_1810: f => finalizeWrapper(f,x0 => dartInstance.exports._1810(f,x0)),
_1828: (x0,x1) => x0.key(x1),
_1829: x0 => x0.trustedTypes,
_1831: (x0,x1) => x0.text = x1,
_1833: (a, i) => a.push(i),
_1837: a => a.pop(),
_1838: (a, i) => a.splice(i, 1),
_1840: (a, s) => a.join(s),
_1841: (a, s, e) => a.slice(s, e),
_1844: a => a.length,
_1846: (a, i) => a[i],
_1847: (a, i, v) => a[i] = v,
_1849: a => a.join(''),
_1850: (o, a, b) => o.replace(a, b),
_1852: (s, t) => s.split(t),
_1853: s => s.toLowerCase(),
_1854: s => s.toUpperCase(),
_1855: s => s.trim(),
_1856: s => s.trimLeft(),
_1857: s => s.trimRight(),
_1859: (s, p, i) => s.indexOf(p, i),
_1860: (s, p, i) => s.lastIndexOf(p, i),
_1861: (o, offsetInBytes, lengthInBytes) => {
      var dst = new ArrayBuffer(lengthInBytes);
      new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
      return new DataView(dst);
    },
_1862: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
_1863: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
_1864: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
_1865: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
...
_1872: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
_1873: Object.is,
_1874: (t, s) => t.set(s),
...
_1908: s => stringToDartString(stringFromDartString(s).toUpperCase()),
_1909: s => stringToDartString(stringFromDartString(s).toLowerCase()),
_1911: (s, m) => {
          try {
...
_1913: (x0,x1) => x0.test(x1),
_1914: (x0,x1) => x0.exec(x1),
_1915: (x0,x1) => x0.exec(x1),
_1916: x0 => x0.pop(),
_1920: (x0,x1,x2) => x0[x1] = x2,
_1922: o => o === undefined,
_1923: o => typeof o === 'boolean',
_1924: o => typeof o === 'number',
_1926: o => typeof o === 'string',
_1929: o => o instanceof Int8Array,
_1930: o => o instanceof Uint8Array,
...
_1936: o => o instanceof Float32Array,
_1937: o => o instanceof Float64Array,
_1938: o => o instanceof ArrayBuffer,
_1939: o => o instanceof DataView,
_1940: o => o instanceof Array,
_1941: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_1943: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_1944: o => o instanceof RegExp,
_1945: (l, r) => l === r,
_1946: o => o,
_1947: o => o,
_1948: o => o,
...
_1950: o => o.length,
_1953: (o, i) => o[i],
_1954: f => f.dartFunction,
_1955: l => arrayFromDartList(Int8Array, l),
_1956: l => arrayFromDartList(Uint8Array, l),
_1957: l => arrayFromDartList(Uint8ClampedArray, l),
_1958: l => arrayFromDartList(Int16Array, l),
_1959: l => arrayFromDartList(Uint16Array, l),
_1960: l => arrayFromDartList(Int32Array, l),
_1961: l => arrayFromDartList(Uint32Array, l),
_1962: l => arrayFromDartList(Float32Array, l),
_1963: l => arrayFromDartList(Float64Array, l),
_1964: (data, length) => {
...
_1965: l => arrayFromDartList(Array, l),
_1966: stringFromDartString,
_1967: stringToDartString,
_1968: () => ({}),
_1969: () => [],
_1970: l => new Array(l),
_1971: () => globalThis,
_1972: (constructor, args) => {
...
_1974: (o, p) => o[p],
_1975: (o, p, v) => o[p] = v,
_1976: (o, m, a) => o[m].apply(o, a),
_1978: o => String(o),
_1979: (p, s, f) => p.then(s, f),
_1980: s => {
...
_2021: () => globalThis.window,
_2042: x0 => x0.matches,
_2046: x0 => x0.platform,
_2051: x0 => x0.navigator,
_2404: (x0,x1) => x0.href = x1,
_3439: (x0,x1) => x0.src = x1,
_3441: (x0,x1) => x0.type = x1,
_3445: (x0,x1) => x0.async = x1,
_3449: (x0,x1) => x0.crossOrigin = x1,
_3451: (x0,x1) => x0.text = x1,
_3860: () => globalThis.window,
_3940: x0 => x0.navigator,
_4196: x0 => x0.trustedTypes,
_4198: x0 => x0.localStorage,
_4421: x0 => x0.userAgent,
_4639: x0 => x0.length,
_8835: () => globalThis.document,
_8925: x0 => x0.body,
_8926: x0 => x0.head,
_9291: (x0,x1) => x0.id = x1,
_9300: (x0,x1) => x0.innerHTML = x1,
_14679: () => globalThis.console,
_14704: x0 => x0.name,
_14705: x0 => x0.message,
_14706: x0 => x0.code
    };
